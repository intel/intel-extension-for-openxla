...
PJRT_Error* ITEX_PJRT_Buffer_Destroy(PJRT_Buffer_Destroy_Args* args) {
  PJRT_RETURN_IF_ERROR(CheckMatchingStructSizes(
      "PJRT_Buffer_Destroy_Args", PJRT_Buffer_Destroy_Args_STRUCT_SIZE,
      args->struct_size));
...
constexpr PJRT_Api CreatePjrtApi() {
  return PJRT_Api{
      ...
      /*PJRT_Plugin_Initialize=*/pjrt::PJRT_Plugin_Initialize_NoOp,
      ...
      /*PJRT_Client_Create=*/pjrt::PJRT_Client_Create,
      ...
      /*PJRT_TopologyDescription_Create=*/pjrt::PJRT_TopologyDescription_Create,
...
constexpr PJRT_Api CreateITEXPjrtApi() {
  ...
  api.PJRT_Buffer_Destroy = pjrt::ITEX_PJRT_Buffer_Destroy;
  return api;
}
