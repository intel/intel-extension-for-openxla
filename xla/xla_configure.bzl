...
def _symlink_genrule_for_dir(
    ...
    for i in range(len(dest_files)):
        # Do not copy unused file to local repository to speed up building
        if dest_files[i] != "" and (dest_files[i].lower().rfind("third_party") == -1 and
                                    dest_files[i].lower().rfind("external") == -1 and
                                    dest_files[i].lower().rfind("absl") == -1 and
                                    dest_files[i].lower().rfind("eigen") == -1):
