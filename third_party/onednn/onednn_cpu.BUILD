...
template_rule(
    ...
    substitutions = select({
        "@intel_extension_for_openxla//third_party/onednn:build_with_tbb": _DNNL_RUNTIME_TBB,
...
cc_library(
    ...
    deps = ["@intel_extension_for_openxla//third_party/onednn:intel_binary_blob"],
)
...
load("@intel_extension_for_openxla//third_party/onednn:build_defs.bzl", "if_llga_debug")
