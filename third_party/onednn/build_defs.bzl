...
def if_llga_debug(if_true, if_false = []):
    ...
    """
    return select({
        "@intel_extension_for_openxla//third_party/onednn:build_with_llga_debug": if_true,
        "//conditions:default": if_false,
    })
...
def if_graph_compiler(if_true, if_false = []):
    ...
    """
    return select({
        "@intel_extension_for_openxla//third_party/onednn:build_with_graph_compiler": if_true,
        "//conditions:default": if_false,
    })
