...
_CMAKE_COMMON_LIST = {
    "#cmakedefine DNNL_CPU_RUNTIME DNNL_RUNTIME_${DNNL_CPU_RUNTIME}": if_sycl_build_is_configured("#define DNNL_CPU_RUNTIME DNNL_RUNTIME_SYCL", "#define DNNL_CPU_RUNTIME DNNL_RUNTIME_SYCL"),
    ...
    "#cmakedefine DNNL_GPU_RUNTIME DNNL_RUNTIME_${DNNL_GPU_RUNTIME}": if_sycl_build_is_configured("#define DNNL_GPU_RUNTIME DNNL_RUNTIME_SYCL", "#define DNNL_GPU_RUNTIME DNNL_RUNTIME_SYCL"),
    "#cmakedefine DNNL_SYCL_SYCL": if_sycl_build_is_configured("#define DNNL_SYCL_SYCL", "/* #undef DNNL_SYCL_SYCL */"),
