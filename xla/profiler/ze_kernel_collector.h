...
#ifndef XLA_PROFILER_ZE_KERNEL_COLLECTOR_H_
#define XLA_PROFILER_ZE_KERNEL_COLLECTOR_H_
...
#include "xla/profiler/ze_utils.h"
 ...
 private:  // Implementation
  ...
  void ProcessCall(const ZeKernelCall* call) {
    ...
    ZeKernelCollector::GetzePluggableTracerEventMap()[call->queue].emplace_back(
        tsl::port::MaybeAbiDemangle(command->props.name.c_str()),
...
#endif  // XLA_PROFILER_ZE_KERNEL_COLLECTOR_H_
