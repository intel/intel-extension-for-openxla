...
Status IrEmitterUnnested::EmitCclThunk(mlir::Operation* untyped_op) {
  ...
  VLOG(2) << CclThunkType::GetHloOpName()
  ...
  Status implementable_status =
      CclThunkType::CheckImplementable(op, replica_count, partition_count);
  bool should_use_ccl_thunk = !is_degenerate && implementable_status.ok();
...
Status IrEmitterUnnested::EmitCclAsyncDone(Thunk::Kind kind,
  ...
  if (async_executor.mapped() != nullptr) {
    AddThunkToThunkSequence(std::make_unique<CclCollectiveDoneThunk>(
...
Status IrEmitterUnnested::EmitOp(mlir::Operation* op) {
  ...
  if (mlir::isa<mlir::lmhlo_gpu::CollectivePermuteDoneOp>(op)) {
    return EmitCclAsyncDone<mlir::lmhlo_gpu::CollectivePermuteDoneOp>(
  ...
  if (mlir::isa<mlir::lmhlo_gpu::AllGatherDoneOp>(op)) {
    return EmitCclAsyncDone<mlir::lmhlo_gpu::AllGatherDoneOp>(
  ...
  if (mlir::isa<mlir::lmhlo_gpu::AllReduceDoneOp>(op)) {
    return EmitCclAsyncDone<mlir::lmhlo_gpu::AllReduceDoneOp>(
  ...
  if (mlir::isa<mlir::lmhlo_gpu::ReduceScatterDoneOp>(op)) {
    return EmitCclAsyncDone<mlir::lmhlo_gpu::ReduceScatterDoneOp>(
  ...
  if (mlir::isa<mlir::lmhlo_gpu::AllToAllDoneOp>(op)) {
    return EmitCclAsyncDone<mlir::lmhlo_gpu::AllToAllDoneOp>(
